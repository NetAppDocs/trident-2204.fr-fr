...
* Amélioration de l'analyse des noms d'initiateurs iSCSI. (Problème [#681](https://github.com/NetApp/trident/issues/681))[]
* Problème résolu lorsque les paramètres de classe de stockage CSI n'étaient pas autorisés. (Problème [#598](https://github.com/NetApp/trident/issues/598))[]
* Déclaration de clé en double fixe dans Trident CRD. (Problème [#671](https://github.com/NetApp/trident/issues/671))[]
* Correction des journaux CSI instantanés erronés. (Problème [#629](https://github.com/NetApp/trident/issues/629))[]
* Résolution du problème lié à l'annulation de la publication des volumes sur les nœuds supprimés. (Problème [#691](https://github.com/NetApp/trident/issues/691))[]
* Ajout de la gestion des incohérences du système de fichiers sur les périphériques en bloc. (Problème [#656](https://github.com/NetApp/trident/issues/656))[]
* Problème résolu extraction automatique des images lors de la configuration du `imageRegistry` indicateur pendant l'installation. (Problème [#715](https://github.com/NetApp/trident/issues/715))[]
...
* Les connexions entrantes aux terminaux sécurisés de Trident requièrent désormais un minimum de TLS 1.3. (Problème [#698](https://github.com/NetApp/trident/issues/698))[]
...
* *Kubernetes*: Trident demonset s'exécute maintenant dans la classe de priorité critique du nœud système. (Problème [#694](https://github.com/NetApp/trident/issues/694))[]

...
| `limitVolumeSize` | Echec du provisionnement si la taille du volume demandé est supérieure à cette valeur pour le pilote d'économie. | « » (non appliqué par défaut) 

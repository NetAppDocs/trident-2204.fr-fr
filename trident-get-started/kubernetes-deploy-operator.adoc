...
* Manuellement : Trident fournit un link:https://github.com/NetApp/trident/blob/stable/v22.04/deploy/bundle.yaml["pack.yaml"^] fichier pouvant être utilisé pour installer l'opérateur et créer des objets associés.
